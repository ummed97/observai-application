...
import { Activity, Eye, EyeOff, Github, CheckCircle2 } from 'lucide-react';
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 bg-[#0F111A] text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl font-bold leading-tight mb-6">
            AI-Agentic Observability for <span className="text-blue-500">Cloud & Infrastructure</span>
          </h1>

          <p className="text-gray-400 text-lg max-w-md">
            Monitor, diagnose, and remediate infrastructure issues in real-time with autonomous AI agents.
          </p>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-4 text-sm text-gray-500">
          ...
          <p>Trusted by 500+ DevOps teams</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-gray-50">
        <div className="w-full max-w-md space-y-8 bg-white p-10 rounded-2xl shadow-xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div
              className={`flex items-center p-4 rounded-lg border cursor-pointer transition-all ${isHuman ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200 hover:bg-gray-100'}`}
              onClick={() => setIsHuman(!isHuman)}
            >
              <div className={`w-6 h-6 rounded border flex items-center justify-center mr-3 transition-colors ${isHuman ? 'bg-green-500 border-green-500' : 'bg-white border-gray-300'}`}>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ObservAI monitors your infrastructure in real-time.
          </p>
        </div>
      </div>
    </div>
